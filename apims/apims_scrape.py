# -*- coding: utf-8 -*-
"""
Created on Tue Dec 15 13:19:16 2020
...
df2.to_csv('D:/apims-2018-2020.csv',date_format='%Y-%m-%d %H:%M')

with open('D:/apims-2018-2020.csv', 'r') as file :
  filedata = file.read()
filedata = filedata.replace('.0', '').replace(',0,0,', ',,,').replace(',0,', ',,')
with open('D:/apims-2018-2020.csv', 'w') as file:
  file.write(filedata)
